...
SimpleSim.add_param('omega_0', 8.4e9*2*pi)
...
SimpleSim.add_EOM('a', '- 1j*omega_0*a - 1j*g*cos(omega_p*t)*a - 1e8*cos(omega_d1*t) - 1e8*cos(omega_d1*t)')
SimpleSim.set_solve_type('decimate')

SimpleSim.specify_time(30, 50, d_factor=2)
