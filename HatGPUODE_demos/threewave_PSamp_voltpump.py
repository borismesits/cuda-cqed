...
SimpleSim.add_paramsweep('logAs', 3, 5, 100)
SimpleSim.add_paramsweep('Ap', 0, 250000, 2)
...
SimpleSim.param_dict_nosweep['phi'] = pi/2
SimpleSim.param_dict_nosweep['Ap'] = 250000
SimpleSim.param_dict_nosweep['logAs'] = 0
...
disp_final = np.sqrt(bout_I**2+bout_Q**2)[:, :, :, -1]
