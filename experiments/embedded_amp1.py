...
SimpleSim.add_paramsweep('chi', 0, 10e6 * 2 * np.pi, 30)
SimpleSim.add_paramsweep('logka', 0, 5e6 * 2 * np.pi, 30)
...
SimpleSim.add_paramsweep('amplC1', 0, 0.36, 101)  # 6 - c1
...
ka = SimpleSim.paramsweep_dict['ka']/(2*pi)

plt.figure(3)
plt.pcolor(ka, chi, np.log10(a_nbar[:,:, 0,-1]))
plt.colorbar()

plt.figure(4)
plt.pcolor(ka, chi, np.log10(b_separation[:,:, -1]))
plt.colorbar()
...
plt.figure(6)
plt.clf()
plt.plot(I[4,chi_i,0,amplC1_i,:], Q[4,chi_i,0,amplC1_i,:])
plt.plot(I[4,chi_i,1,amplC1_i,:], Q[4,chi_i,1,amplC1_i,:])


plt.figure(6)
plt.clf()
plt.plot(I[6,chi_i,0,amplC1_i,:], Q[6,chi_i,0,amplC1_i,:])
plt.plot(I[6,chi_i,1,amplC1_i,:], Q[6,chi_i,1,amplC1_i,:])
